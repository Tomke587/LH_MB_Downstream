...
MBON_partners <- readRDS(file = "/Users/tomke/Documents/dev/LH_MB_Downstream/MBON_partner_summary_out_types_06.10.Rds")
PN_partners <- readRDS(file = "/Users/tomke/Documents/dev/LH_MB_Downstream/PN_partner_summary_out_types_05.10.Rds")
LHN_partners <- readRDS(file = "/Users/tomke/Documents/dev/LH_MB_Downstream/LHN_partner_summary_out_types_05.10.Rds")
```
remove LHCENT
...
saveRDS(PN_MBON_common_partners_10_df, file="PN_MBON_common_partners_10_df_06.10.Rds", version = NULL,
...
# 2444 common partners downstream of PN and MBONs
...
saveRDS(LHN_MBON_common_partners_10_df, file="LHN_MBON_common_partners_10_df_06.10.Rds", version = NULL,
        compress = TRUE, refhook = NULL)
```
...
```{r top partner ids}
# look at the unique ids
LHN_MBON_common_partners_10_u = subset(LHN_MBON_common_partners_10, select = c(post_id, post_type, xyz))
LHN_MBON_common_partners_10_u = unique(LHN_MBON_common_partners_10_u)
nrow(LHN_MBON_common_partners_10_u)
write.csv(LHN_MBON_common_partners_10_u, file = "LHN_MBON_common_partners_10_u_06.10.csv")
nrow(LHN_MBON_common_partners_10_u) 
...
ggsave("LHN_MBON_c20_plot_06.10.png")
LHN_MBON_c20_plot
```
...
ggsave("LHN_MBON_c50_plot_06.10.png")
LHN_MBON_c50_plot
```
DNs
