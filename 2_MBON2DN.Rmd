...
saveRDS(MBON_partner_summary_out_types, file="MBON_partner_summary_out_types_06.10.Rds", version = NULL,
...
saveRDS(MBON_partner_summary_out_types2, file="MBON_partner_summary_out_types_06.10.Rds", version = NULL,
        compress = TRUE, refhook = NULL)
```
```{r open saved all that are not PNs}
MBON_partner_summary_out_types2 <- readRDS(file = paste0(here::here(),'/Users/tomke/Documents/dev/LH_MB_Downstream/MBON_partner_summary_out_types_06.10.Rds'))
```
...
saveRDS(directDN_con, file="MBON_directDN_con_06.10.Rds", version = NULL,
         compress = TRUE, refhook = NULL)
directDN_con
```
```{r open saved DNs directly downstream}
directDN_con <- readRDS(file = paste0(here::here(),'/Users/tomke/Documents/dev/MBON_directDN_con_06.10.Rds'))
```
