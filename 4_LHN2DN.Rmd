...
LHN_partner_summary_out_types2 <- readRDS(file = paste0(here::here(),'/Users/tomke/Documents/dev/LH_MB_Downstream/LHN_partner_summary_out_types_14.7.Rds'))
```
...
# 59 direct DNs downstream of LHNs
saveRDS(directDN_con10, file="LHN_directDN_con.05.10.Rds", version = NULL,
         compress = TRUE, refhook = NULL)
```
```{r open saved DNs directly downstream}
directDN_con <- readRDS(file ="/Users/tomke/Documents/dev/LH_MB_Downstream/LHN_directDN_con.Rds")
```
